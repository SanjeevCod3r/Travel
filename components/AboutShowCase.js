    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          >
            Since our founding, Excursion Travel has been dedicated to providing exceptional transportation
            services that combine luxury, reliability, and personalized care.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto">
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?crop=entropy&cs=srgb&fm=jpg&q=85';
              }}
            />
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <p className="text-lg text-gray-700 leading-relaxed mb-8" style={{ fontFamily: 'Manrope, sans-serif' }}>
              We understand that every journey is unique, and we're here to make yours unforgettable.
              Our commitment to excellence ensures that every ride with Excursion Travel is crafted for your
