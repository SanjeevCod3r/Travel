  ...
  const featuredPackages = [
    {
      ...
      description:
        "Experience India's most iconic destinations with the Golden Triangle Tour featuring Delhi, Agra and Jaipur.",
    },
    {
      id: 2,
      ...
      description:
        "Discover the pristine beauty of Himachal Pradesh with its charming hill stations and breathtaking landscapes.",
    },
    {
      id: 3,
      ...
      description:
        "Embark on an unforgettable desert safari through Rajasthan's golden sands and ancient forts.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <div className="inline-block px-6 py-2 bg-[#0056D2]/10 rounded-full mb-4">
            <span
              className="text-[#0056D2] font-semibold text-sm"
          ...
          >
            ...
            experiences across India's most captivating destinations.
          </p>
        </motion.div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-medium text-[#0056D2] bg-[#0056D2]/10 px-3 py-1 rounded-full">
                    {pkg.region.charAt(0).toUpperCase() + pkg.region.slice(1)}{" "}
                    India
                  </span>
