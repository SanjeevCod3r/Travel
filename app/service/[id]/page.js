    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/services" className="text-[#0056D2] hover:underline">Return to Services</Link>
        </div>
      </div>
    );
  }
            ...
            <div className="relative z-10 container mx-auto px-6 lg:px-12">
              <div className="flex justify-center items-center min-h-screen">
                ...
                >
                  ...
                  >
                    <a href="tel:+919990817615" className="bg-gradient-to-r from-[#0056D2] to-[#003DA6] hover:from-[#0041A8] hover:to-[#002D80] text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl flex items-center gap-3 justify-center">
                      <Phone className="w-5 h-5" />
                      Call Now: +91 9990-817-615
                    </a>
                    <Link href="/contact" className="bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/30 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                      Learn More
                    </Link>
                  </motion.div>
                </motion.div>
              ...
              <div className="max-w-7xl mx-auto">
                ...
                >
                  <div className="inline-flex items-center gap-4 bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-gray-200">
                    ...
                    <Link href="/contact" className="px-6 py-3 bg-gradient-to-r from-[#0056D2] to-[#43E0F8] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 inline-block" style={{ fontFamily: 'Manrope, sans-serif' }}>
                      Start Now
                    </Link>
                  </div>
                </motion.div>
            ...
            <div className="container mx-auto px-6 lg:px-12">
              ...
              <div className="space-y-20">
                {service.content.benefits?.slice(0, 4).map((benefit, index) => {
                  ...
                  const IconMap = {
                    1: Star, 2: Users, 3: CheckCircle, 4: Heart, 5: Clock, 6: Car, 7: Calendar, 8: Sparkles
                  };
                  ...
                  const IconToRender = typeof benefit.icon === 'function' || typeof benefit.icon === 'object' ? benefit.icon : Car;
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                    <a href="tel:+919990817615" className="bg-white text-[#0056D2] px-8 sm:px-10 py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-center hover:scale-105">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5" />
                      Call Now: +91 9990-817-615
                    </a>

                    <Link href="/contact" className="border-2 border-white text-white px-8 sm:px-10 py-3 sm:py-4 rounded-2xl font-bold text-base sm:text-lg hover:bg-white hover:text-[#0056D2] transition-all duration-300 w-full sm:w-auto text-center hover:scale-105">
                      Get Quote
                    </Link>
                  </div>
